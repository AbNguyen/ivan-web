...
import { revenue, invoices, customers, latestInvoices, invoicesTable } from '../lib/placeholder-data';
...
export async function fetchCardData() {
  try {
    ...
    const totalPaidInvoices = formatCurrency(invoiceStatusPromise.paid);
    const totalPendingInvoices = formatCurrency(invoiceStatusPromise.pending);
